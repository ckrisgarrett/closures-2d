...
{
    #ifdef USE_PAPI
    profile_start_update("DnSolver::getInnerBoundaries");
    #endif
    ...
    #ifdef USE_PAPI
    profile_finish_update("DnSolver::getInnerBoundaries");
    #endif
}
...
{
    #ifdef USE_PAPI
    profile_start_update("DnSolver::setOuterBoundaries");
    #endif
    ...
    #ifdef USE_PAPI
    profile_finish_update("DnSolver::setOuterBoundaries");
    #endif
}

void DnSolver::duplicateBoundaries() {
    #ifdef USE_PAPI
    profile_start_update("DnSolver::duplicateBoundaries");
    #endif
    ...
    #ifdef USE_PAPI
    profile_finish_update("DnSolver::duplicateBoundaries");
    #endif
}
